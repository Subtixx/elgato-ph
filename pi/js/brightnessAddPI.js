...
function BrightnessAddPI(inContext, inLanguage, inStreamDeckVersion, inPluginVersion) {
    // Init BrightnessPI
    var instance = this;
    ...
    this.localize = function() {
        ...
        document.getElementById('brightness-label').innerHTML = instance.localization['BrightnessAdd'];
    };
    ...
    var brightnessSlider = "<div type='range' class='sdpi-item'> \
                                ...
                                <div class='sdpi-item-value'> \
                                    <input class='floating-tooltip' data-suffix='%' type='range' id='brightness-input' min='1' max='99' value='" + settings.brightnessAdd + "'> \
                                </div> \
                           </div>";
    ...
    function brightnessChanged(inEvent) {
        ...
        settings.brightnessAdd = inEvent.target.value;
